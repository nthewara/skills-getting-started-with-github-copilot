...
activities = {
    # Sports activities
        "Basketball Team": {
            "description": "Competitive basketball team with regular practices and inter-school games",
        ...
        "Science Club": {
            "description": "Hands-on experiments, science competitions, and research projects",
